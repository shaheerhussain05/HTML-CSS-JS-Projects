...
// Function to add generated word to the DOM
function renderWord() {
    // Generate a random word to render
...
function gameover() {
    // Add content in the gameover container
...
// 2. listen for click on the settingsBtn
settingsBtn.addEventListener('click', () => {
    settingsContainer.classList.toggle('hide');
});

// 3. listen for change in the settings form
settingsForm.addEventListener('change', e => {
    // Change difficulty setting based on user input
